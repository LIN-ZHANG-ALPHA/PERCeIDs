...
function [DIV_order,DIV_best,NMI]  = evaluation(Fac_PCD_L1,Fac_LARC,Fac_NTF,opts)
...
%     [order_pcd_L1, best_pcd_L1]    = evalMatch(commu_pcd_L1, groundtruth);
% %    [order_pcd_L2, best_pcd_L2]    = evalMatch(commu_pcd_L2, groundtruth);
%     [order_larc, best_larc]  = evalMatch(commu_larc, groundtruth);
%     [order_ntf, best_ntf]    = evalMatch(commu_ntf, groundtruth);
%     
